...
class Command(BaseCommand):
    ...
    def _seed_cars(self):
        ...
        from apps.cars.demo_car_seed import (
            apply_car_identity,
            apply_car_model_meta,
            seed_full_car_details,
        )
        ...
        for brand_name, meta in catalog.items():
            ...
            for model_name, cars in meta["models"].items():
                ...
                apply_car_model_meta(car_model, brand_name, model_name, category_map)
                ...
                for spec in cars:
                    ...
                    seed_full_car_details(car, brand_name, model_name, category_map)
